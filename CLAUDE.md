...
| 카테고리 | 디렉토리 | 내용 |
|----------|----------|------|
| 핵심 개념 | `docs/core-concepts/` | 아키텍처, 인덱스 설계, Query DSL |
| 운영 | `docs/operations/` | 인덱스/클러스터 관리, 스냅샷 |
| 성능 | `docs/performance/` | 인덱싱/검색 최적화, 리소스 튜닝 |
| 보안 | `docs/security/` | 인증, 인가, TLS |
| 관찰 가능성 | `docs/observability/` | 모니터링, 슬로우 로그 |
